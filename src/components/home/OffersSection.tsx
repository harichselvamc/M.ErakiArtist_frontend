    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
          ...
          {offers.map((offer, i) => (
            ...
            >
              ...
              {offer.discountPercentage && (
                <div className="absolute top-4 right-4 bg-green-500 text-white text-xs font-bold px-2 py-1 rounded flex items-center">
              ...
              <div className="p-5">
                ...
                <button 
                  className="w-full flex items-center justify-center bg-gray-900 hover:bg-gray-800 text-white py-3 px-4 rounded-lg transition-colors duration-300 font-medium"
        ...
        <div className="text-center mt-12">
          ...
          <button 
            className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white py-3 px-8 rounded-lg shadow-md transition-all duration-300 font-medium"
