          ...
          >
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={isSending}
                className={`btn btn-primary w-full flex items-center justify-center ${isSending ? 'cursor-not-allowed opacity-60' : ''}`}
              >
            ...
            <div className="bg-primary-950 text-white p-8 rounded-lg mb-8">
              ...
              <ul className="space-y-6">
                <li className="flex items-start">
                  ...
                  <div><p className="font-medium">Phone</p><p className="mt-1">+91 7598068106</p></div>
                </li>
                <li className="flex items-start">
                  <Mail className="w-5 h-5 mr-4 mt-1 text-accent-400" />
                  <div><p className="font-medium">Email</p><p className="mt-1">harichselvamc@gmail.com</p></div>
                </li>
                <li className="flex items-start">
                  <MapPin className="w-5 h-5 mr-4 mt-1 text-accent-400" />
                  <div><p className="font-medium">Location</p><p className="mt-1">Tamil Nadu, India</p></div>
                </li>
              </ul>
            </div>
